...
import { SneakerSaleCard_STYLE_ARTICLE, SneakerSaleCard_STYLE_DIV_1, SneakerSaleCard_STYLE_IMG } from '../utils/Constants/style';
...
const SneakerSaleCard = ({vente,model,price,misc}) => {
  return (
    ...
    <a href="" class="button__light">{misc}</a>
    </article>
